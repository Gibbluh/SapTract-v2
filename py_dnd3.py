...
# The second 'return (' in the file is the main return of SuperAdminDashboard.
parts = content.split('  return (')

if len(parts) >= 3:
    # parts[0] is everything before SortableItem return
    # parts[1] is inside SortableItem return
    # parts[2] is inside SuperAdminDashboard return (what we want to replace)
    
    new_content = parts[0] + '  return (' + parts[1] + metrics_code + charts_code + dnd_wrapper + "\n};\n\nexport default SuperAdminDashboard;\n"
